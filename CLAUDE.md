...
components/
  ...
  pedido/         # Seguimiento público del pedido (Fase 17) — la ÚNICA pantalla del proyecto
                  ...
                  #   `discount` para la fila de cupón (ver lib/api/orders.ts)
