  ...
  return (
    <LegalLayout
      ...
      callout={{
        ...
        text: "Nuestro outlet reúne piezas de temporadas pasadas y modelos que ya no se producen — artículos con historia, carácter propio y precios accesibles. Son oportunidades únicas: cada par es irrepetible porque ya no existe en catálogo activo. Eso también implica que no hay existencias de respaldo para realizar cambios o devoluciones, condición que aceptas al momento de la compra.",
      }}
      sections={SECTIONS}
      footerNote={`© ${new Date().getFullYear()} Botas Don Chuy. Todos los derechos reservados. Outlet de modelos descontinuados — venta final.`}
    />
  );
}
