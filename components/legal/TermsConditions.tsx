...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      "Cada artículo cuenta con descripción, fotografías y, cuando aplica, señalización de uso o de pequeños detalles estéticos propios de su condición de outlet. Las fotografías son referenciales: pueden existir variaciones menores de tono por calibración de pantalla o condiciones de iluminación.",
