...
export default function OutletFilters({
  ...
  return (
    <motion.div
      ...
      className="flex flex-wrap items-center gap-3 mb-10 max-w-7xl mx-auto sticky top-0 z-10 bg-tobacco-950/85 backdrop-blur-sm py-3 md:static md:bg-transparent md:backdrop-blur-none"
    >
      {showCategoria && (
        <select
      ...
      {total !== undefined && (
        <span className="font-sans text-amber-100/40 text-xs sm:text-sm tracking-widest uppercase">
