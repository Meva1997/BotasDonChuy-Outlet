...
export default function OutletCard({
  ...
  return (
    <Link href={`/outlet/${slug}/producto`} className="block">
      <div className="group flex flex-col bg-stone-900 border border-amber-400/10 rounded-sm overflow-hidden hover:border-amber-400/30 transition-all duration-300 hover:scale-105 cursor-pointer">
        {/* Image / Stamp area */}
        <div
